...
"""
This script converts a CSV export of in the format of 'collapsed_noconcat-people-places-group2.csv'
can be used as a service file in the provenance pipelines.

    python ./generate_people_group2_tgn_places.py
"""
...
if __name__ == "__main__":
    ...
    with open("../data/people/people_group2_tgn.json", "w") as f:
