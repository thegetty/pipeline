...
"""
This script converts a CSV export of in the format of 'collapsed-dutch-places.csv'
can be used as a service file in the provenance pipelines.

    python ./generate_sales_dutch_tgn_places.py
"""
...
if __name__ == "__main__":
    ...
    with open("../data/sales/sales_dutch_tgn.json", "w") as f:
        json.dump(data, f, indent=4, sort_keys=True, ensure_ascii=False)

    with open("../data/sales/dutch_tgn.json", "w") as f:
