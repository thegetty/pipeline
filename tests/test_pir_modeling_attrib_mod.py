...
class PIRModelingTest_AttributionModifiers(TestProvenancePipelineOutput):
	def test_modeling_for_attribution_modifiers(self):
		...
		style_of_obj = objects['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#OBJ,Br-A2493,0029%5Bb%5D,1800-03-01']
		...
		possibly_by_obj = objects['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#OBJ,B-A13,0086,1738-07-21']
		...
		formerly_obj = objects['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#OBJ,B-A160,0221,1776-04-30']
		...
		copy_after_obj = objects['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#OBJ,B-A136,0089,1773-07-20']
		...
		attributed_to_obj = objects['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#OBJ,B-A138,0022,1774-05-30']
