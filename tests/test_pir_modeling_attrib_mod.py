...
class PIRModelingTest_AttributionModifiers(TestProvenancePipelineOutput):
	def test_modeling_for_attribution_modifiers(self):
		...
		possibly_by_obj = objects['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#OBJ,B-A13,0086,1738-07-21']
		...
		formerly_obj = objects['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#OBJ,B-A160,0221,1776-04-30']
		...
		attributed_to_obj = objects['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#OBJ,B-A138,0022,1774-05-30']
