...
class PIRModelingTest_AttributionModifiers(TestProvenancePipelineOutput):
	def test_modeling_for_attribution_modifiers(self):
		...
		b_ft_obj = activities['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#PROV,Br-A450,1751-03-08,0044']
		...
		b_and_obj = activities['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#PROV,Br-A458,1751-06-13,0031']
...
# 		s_and_obj = activities['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#PROV,Br-1299,1815-06-10,0060']
...
# 		self.assertEqual(acq_people, {'Grey, Charles', 'Gent, G.W.'})
		...
		s_ft_obj = activities['tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#PROV,Br-1344,1815-12-02,0075']
