...
class PIRModelingTest_StockListSales(TestProvenancePipelineOutput):
	...
	def verify_catalogs(self, output):
		...
		expected_event_id = 'tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#STOCK_LIST-EVENT,CATALOGNUMBER,Br-541'
	...
	def verify_sales(self, output):
		...
		* An Activity modeling the individual private sale
		...
		hmo_key = 'tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#OBJECT,Br-541,%5B0001%5D,1808'
		hmo = objects[hmo_key]
		
		sale_curr = activities['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#AUCTION,Br-541,LOT,%5B0001%5D,DATE,1808']
		
		event_key = 'tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#STOCK_LIST-EVENT,CATALOGNUMBER,Br-541'
		sale_event = activities[event_key]
		
		object_set_key = 'tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#AUCTION,Br-541,LOT,%5B0001%5D,DATE,1808-Set'
