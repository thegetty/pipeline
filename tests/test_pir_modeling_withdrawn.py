...
class PIRModelingTest_Withdrawn(TestProvenancePipelineOutput):
	def test_modeling_for_withdrawn_records(self):
		...
		procurement = procurements['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#AUCTION-TX,Br-3039,1827-11-24,0082']
		...
		withdrawn_obj = objects['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#OBJECT,Br-3039,0082%5Bb%5D,1827-11-24']
		withdrawn_rec = texts['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#CATALOG,Br-3039,RECORD,343048']

		sold_obj = objects['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#OBJECT,Br-3039,0082%5Ba%5D,1827-11-24']
		...
		set_id = 'tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:provenance#AUCTION,Br-3039,LOT,0082,DATE,1827-11-24-Set'
