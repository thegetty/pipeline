...
class TestProvenancePipelineOutput(unittest.TestCase):
	...
	def test_pipeline_pir(self):
		...
		key_119 = 'tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#AUCTION,B-A139,0119,1774-05-31'
		key_120 = 'tag:getty.edu,2019:digital:pipeline:provenance:REPLACE-WITH-UUID#AUCTION,B-A139,0120,1774-05-31'
