...
class PIRModelingTest_AR110(TestSalesPipelineOutput):
    def test_modeling_ar110(self):
        ...
        obj1 = vi['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:sales#OBJ,B-A138,0023,1774-05-30-VisItem']
        obj2 = vi['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:sales#OBJ,B-A139,0119%5Ba%5D,1774-05-31-VisItem']
        obj3 = vi['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:sales#OBJ,B-A139,0194%5Ba%5D,1774-05-31-VisItem']
        obj4 = vi['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:sales#OBJ,D-B1153,0320%5Ba%5D,1908-04-08-VisItem']
