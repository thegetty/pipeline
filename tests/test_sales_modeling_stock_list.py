...
# 		pprint.pprint(output)
		...
		self.assertEqual(pvt_sale['_label'], 'Stock List Event Br-541 (1808)')
	...
	def verify_sales(self, output):
		...
		* An Activity modeling the individual private sale
		...
		sale_curr = sale_activities['tag:getty.edu,2019:digital:pipeline:REPLACE-WITH-UUID:sales#AUCTION,Br-541,%5B0001%5D,1808']
